package cn.cstube.vodservice.controller;

import cn.cstube.baseservice.handler.GuliException;
import cn.cstube.commonutils.R;
import cn.cstube.vodservice.utils.AliyunVodSDKUtils;
...
public class VideoAdminController {
    ...
    public R uploadVideo(MultipartFile file){
        ...
        try {
            ...
            UploadStreamRequest request = new UploadStreamRequest(
                    "LTAI5tBB3kqZ4bvgLPVQx1SV",
                    "AuUa3CvhGu9h0ZRS3KUtjZ0qkvO5Bt",
                    title,
                    originalFilename,
                    inputStream
            );
    ...
    public R delVideo(@PathVariable("videoId") String videoId){
        ...
        try {
            //*初始化客户端对象
            DefaultAcsClient client = AliyunVodSDKUtils.initVodClient("LTAI5tBB3kqZ4bvgLPVQx1SV",
                    "AuUa3CvhGu9h0ZRS3KUtjZ0qkvO5Bt");
            //*创建请求对象（不同操作，类不同）
    ...
    public R getPlayAuth(@PathVariable String vid){
        try {
            //（1）创建初始化对象
            DefaultAcsClient client = AliyunVodSDKUtils.initVodClient("LTAI5tBB3kqZ4bvgLPVQx1SV", "AuUa3CvhGu9h0ZRS3KUtjZ0qkvO5Bt");
